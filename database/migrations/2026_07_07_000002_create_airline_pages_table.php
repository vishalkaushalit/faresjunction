    ...
    public function up(): void
    {
        ...
        $airlines = [
            ...
            [
                ...
                'code' => 'EK',
                'intro' => 'Explore Emirates Airlines flights, cabin options, baggage support, and international route planning with Fares Junction.',
                'routes' => [
        ...
        DB::table('airline_pages')->insert(collect($airlines)->map(function (array $airline, int $index) use ($sectionLabels, $now): array {
            $sections = collect($sectionLabels)->mapWithKeys(function (string $title, string $key) use ($airline): array {
                return [$key => [
                    'title' => $title,
                    'body' => match ($key) {
                        'overview' => "{$airline['name']} is a major airline serving domestic and international routes. Use this page to compare flight options, review common travel policies, and connect with Fares Junction for booking support.",
                        'book-manage' => "Fares Junction can help you book {$airline['name']} flights, review fare choices, add travelers, and understand booking updates before your trip.",
                        ...
                        'cancellation' => "Cancellation eligibility, travel credits, and refund timelines depend on fare rules. Fares Junction can help you review your {$airline['name']} ticket conditions.",
                        ...
                        'deals' => "Call Fares Junction to compare published and available {$airline['name']} fares for your dates, route, and cabin preference.",
                        ...
                        'vacations' => "Bundle flights, hotels, cars, or activities with Fares Junction for a smoother vacation plan around your {$airline['name']} flights.",
                    },
                ]];
            })->all();
            ...
            return [
                ...
                'meta_title' => "{$airline['name']} Flights & Travel Guide | Fares Junction",
                'meta_description' => "{$airline['intro']} Get 24/7 assistance from Fares Junction.",
                'status' => true,
                'sort_order' => $index + 1,
                'created_at' => $now,
                'updated_at' => $now,
