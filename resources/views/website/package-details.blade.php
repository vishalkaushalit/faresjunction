<?php
$pageTitle = $packageModel->meta_title ?: $pkg['title'] . ' | Fares Junction Packages';
$pageDescription = $packageModel->meta_description ?: $pkg['overview'];
...
<div class="breadcrumb-container">
    <div class="container">
        <ul class="breadcrumbs">
            <li><a href="<?php echo route('website.index'); ?>">Home</a></li>
            <li><a href="<?php echo route('website.packages'); ?>">Packages</a></li>
        ...
        <div class="package-hero-grid">
            ...
            <div class="package-hero-info">
                ...
                <div class="package-hero-price-box">
                    ...
                    <span class="package-hero-price-val" id="hero-price"><?php echo htmlspecialchars($pkg['price']); ?> <span>Per
                            Person</span></span>
                </div>
        ...
        <div class="package-layout-grid">
            ...
            <div class="package-left-col">
                    ...
                    <div class="itinerary-timeline" id="itinerary-timeline">
                        ...
                        <div class="itinerary-day <?php echo $idx === 0 ? 'active' : ''; ?>">
                            <div class="itinerary-day-header <?php echo $idx === 0 ? 'active' : ''; ?>">
                                ...
                                <svg class="itinerary-toggle-icon" viewBox="0 0 24 24" width="20" height="20"
                ...
                <div class="detail-card">
                    ...
                    <div class="why-book-grid">
                        ...
                        <div class="why-item">
                            ...
                            <p class="why-item-desc">Your payments are fully secure with industry-standard encryption.
                            </p>
                        </div>
                        <div class="why-item">
                            <div class="why-item-icon">
                            ...
                            <p class="why-item-desc">Get the lowest flight fares and accommodation rates, guaranteed.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-card" style="border: none; background: transparent; padding: 0; box-shadow: none;">
                    <h2 class="detail-card-title"
                        style="border-bottom: 2px solid var(--gray-200); padding-bottom: 0.85rem;">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor"
                            stroke-width="2">
                            <circle cx="12" cy="12" r="10" />
                    ...
                    foreach ($pkg['related'] as $relKey) {
                      ...
                      if ($relPkg) {
                        ?>
                        <a href="<?php echo route('website.package-details', $relKey); ?>" class="vacation-card"
                            ...
                            <div class="vacation-body" style="padding: 1.25rem;">
                                <h3 class="vacation-title" style="font-size: 1.15rem; margin-bottom: 0.5rem;">
                                    <?php echo htmlspecialchars($relPkg['title']); ?></h3>
                                <p class="vacation-nights"
                                    style="font-size: 0.88rem; min-height: auto; margin-bottom: 0.75rem; display: block; text-align: center;">
                                ...
                                <div class="vacation-price-box" style="padding-top: 0.75rem; margin-bottom: 0.75rem;">
                                    <span class="vacation-price" style="font-size: 1.05rem;">Price starts:
                                        <?php echo htmlspecialchars($relPkg['price']); ?> PP</span>
                                </div>
                                <span class="btn-vacation-offer" style="padding: 0.5rem 0; font-size: 0.85rem;">View
                                    Details</span>
                            </div>
                        </a>
                        <?php
            ...
            <div class="package-right-col">
                <div class="sidebar-sticky-wrapper">
                    @include('website.partials.package-inquiry-form', [
                        'inquiryPrefix' => 'packageLead',
                        'inquiryInterest' => $pkg['title'],
                        'inquirySource' => 'package',
                        'inquiryPackageSlug' => $packageKey,
                    ])
                    ...
                    <div class="most-searched-widget">
                        ...
                        foreach ($packagesData as $pkgKey => $sidePkg) {
                          ...
                          ?>
                                <div class="sidebar-slide <?php echo $slideIdx === 0 ? 'active' : ''; ?>"
                                    data-slide-index="<?php echo $slideIdx; ?>" style="<?php echo $slideIdx === 0 ? '' : 'display: none;'; ?>">
                                    <a href="tel:+13238006001" class="sidebar-pkg-card"
                                        style="text-decoration: none; color: inherit; display: block;">
                                        <div class="sidebar-pkg-img">
                                            <img src="<?php echo htmlspecialchars($sidePkg['heroImage']); ?>" alt="<?php echo htmlspecialchars($sidePkg['title']); ?>"
                                                loading="lazy">
                                        </div>
...
<?php
$extraJS = ['js/package-details.js', 'js/inquiry-form.js'];
$extraCSS = $extraCSS ?? [];
$extraJS = $extraJS ?? [];
