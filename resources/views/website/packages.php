...
?>
        ...
        <section class="packages-hero">
          <div class="blog-hero-content">
            ...
            <div class="inquiry-banner-card" id="flightSearchWidget" style="max-width: 1000px; text-align: left; margin: 0 auto;">
            ...
            <div class="banner-success-card" id="flightSuccessWidget" style="display: none; max-width: 600px; text-align: center; margin: 0 auto;">
              ...
              <h2 style="font-size: 1.8rem; font-weight: 800; color: var(--primary-color); margin-bottom: 0.5rem;">Inquiry Submitted Successfully!</h2>
              <p style="color: var(--gray-600); line-height: 1.6;">Thank you. Our travel desk is planning fares for <strong id="success-flight-route">your trip</strong>. We will contact you shortly with a customized tour proposal.</p>
            </div>
        ...
        <div style="padding: 5rem 0; background-color: var(--gray-100); min-height: 50vh;">
          <div class="container">
            <div style="text-align: center; margin-bottom: 3rem;">
              ...
              <p class="section-subtitle" style="color: var(--gray-500); max-width: 600px; margin: 0.5rem auto 0 auto; line-height: 1.6; font-size: 0.95rem;">Explore handpicked, high-value vacation packages around the globe. Get the lowest fares on flights, hotels, and tours.</p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 2rem;">
              ...
              foreach ($packagesData as $key => $pkg) {
                ...
                ?>
                <a href="package-details.php?package=<?php echo urlencode($key); ?>" class="vacation-card" style="height: 100%; display: flex; flex-direction: column;">
                  ...
                  <div class="vacation-body" style="padding: 1.5rem; display: flex; flex-direction: column; flex-grow: 1; text-align: center;">
                    <h3 class="vacation-title" style="font-size: 1.25rem; font-weight: 700; color: var(--primary-color); margin-bottom: 0.75rem;"><?php echo htmlspecialchars($pkg['title']); ?></h3>
                    <p class="vacation-nights" style="font-size: 0.92rem; color: var(--gray-800); margin-bottom: 0.75rem; display: block; text-align: center;">
                    ...
                    <div class="vacation-stars" style="display: flex; justify-content: center; gap: 3px; color: #ffb800; margin-bottom: 1rem;">
                      <?php echo $starsHtml; ?>
                    </div>
                    <div class="vacation-price-box" style="margin-top: auto; border-top: 1px dashed var(--gray-200); padding-top: 1rem; margin-bottom: 1rem;">
                      <span class="vacation-price-label" style="font-size: 0.85rem; color: var(--gray-500); display: block; margin-bottom: 0.15rem;">Price starts from:</span>
                      <span class="vacation-price" style="font-size: 1.15rem; font-weight: 800; color: var(--primary-color);"><?php echo htmlspecialchars($pkg['price']); ?> Per Person</span>
                    </div>
                    <span class="btn-vacation-offer" style="display: inline-block; width: 100%; padding: 0.65rem 0; border: 1px solid var(--secondary-color); color: var(--secondary-color); background: transparent; border-radius: var(--btn-radius); font-weight: 600; font-size: 0.9rem; text-align: center;">View Offer</span>
                  </div>
                </a>
                <?php
              }
