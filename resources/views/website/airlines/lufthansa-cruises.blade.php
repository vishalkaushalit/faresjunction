    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="lufthansa-cruises.blade.php" class="airline-nav-item active">Cruises</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Cruises</h2>
          <p>Combine your flight with amazing cruise packages for the ultimate vacation experience. with Lufthansa.</p>
        </div>
