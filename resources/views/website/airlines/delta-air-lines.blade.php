    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          <li><a href="delta-air-lines.blade.php" class="airline-nav-item active">Overview</a></li>
          ...
          <li><a href="delta-air-lines-baggage.blade.php" class="airline-nav-item ">Baggage</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Overview</h2>
          <p>Delta Air Lines is a major airline offering flights to domestic and international destinations. Welcome to our comprehensive guide where you can find all the information you need to make your journey smooth and enjoyable.</p>
        </div>
