    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="delta-air-lines-insurance.blade.php" class="airline-nav-item active">Travel Insurance</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          ...
          <p>Protect your trip against unexpected cancellations, medical emergencies, and lost baggage. with Delta Air Lines.</p>
        </div>
