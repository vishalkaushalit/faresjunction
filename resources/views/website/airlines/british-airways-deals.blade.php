    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="british-airways-deals.blade.php" class="airline-nav-item active">Flight Deals</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Flight Deals</h2>
          <p>Check out our latest exclusive discounts and promotional fares. with British Airways.</p>
        </div>
