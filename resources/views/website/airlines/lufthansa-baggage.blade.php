    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="lufthansa-baggage.blade.php" class="airline-nav-item active">Baggage</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Baggage</h2>
          <p>Information on carry-on limits, checked bag fees, overweight and oversized items, and special equipment. with Lufthansa.</p>
        </div>
