    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          <li><a href="lufthansa.blade.php" class="airline-nav-item active">Overview</a></li>
          ...
          <li><a href="lufthansa-unaccompanied.blade.php" class="airline-nav-item ">Unaccompanied Minor & Infant</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Overview</h2>
          <p>Lufthansa is a major airline offering flights to domestic and international destinations. Welcome to our comprehensive guide where you can find all the information you need to make your journey smooth and enjoyable.</p>
        </div>
