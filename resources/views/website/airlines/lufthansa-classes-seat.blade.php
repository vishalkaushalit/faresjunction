    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="lufthansa-classes-seat.blade.php" class="airline-nav-item active">Classes & Seat Selection <span class="arrow">▼</span></a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          ...
          <p>Learn about Main Cabin, Premium Economy, Business Class, and First Class. Find out how to select the best seat for your flight. with Lufthansa.</p>
        </div>
