    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="american-airlines-loyalty.blade.php" class="airline-nav-item active">Loyalty Programs</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          ...
          <p>Discover our loyalty programs, how to earn miles, elite status tiers, and redemption options. with American Airlines.</p>
        </div>
