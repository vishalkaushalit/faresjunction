    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="american-airlines-book-manage.blade.php" class="airline-nav-item active">Book & Manage</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Book & Manage</h2>
          <p>Easily book new flights or manage your existing reservations. Change your seats, update traveler information, and more. with American Airlines.</p>
        </div>
