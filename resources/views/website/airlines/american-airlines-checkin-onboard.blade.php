    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="american-airlines-checkin-onboard.blade.php" class="airline-nav-item active">Check-in & Onboard</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          ...
          <p>Find out about online check-in times, airport kiosks, and the in-flight experience including Wi-Fi, dining, and entertainment. with American Airlines.</p>
        </div>
