    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="british-airways-vacations.blade.php" class="airline-nav-item active">Vacations</a></li>
        </ul>
      </aside>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Vacations</h2>
          <p>All-inclusive packages, hotel bundles, and guided tours powered by our vacations team. with British Airways.</p>
        </div>
