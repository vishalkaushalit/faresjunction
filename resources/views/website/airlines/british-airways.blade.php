    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          <li><a href="british-airways.blade.php" class="airline-nav-item active">Overview</a></li>
          <li><a href="british-airways-book-manage.blade.php" class="airline-nav-item ">Book & Manage</a></li>
          <li><a href="british-airways-classes-seat.blade.php" class="airline-nav-item ">Classes & Seat Selection <span class="arrow">▼</span></a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Overview</h2>
          <p>British Airways is a major airline offering flights to domestic and international destinations. Welcome to our comprehensive guide where you can find all the information you need to make your journey smooth and enjoyable.</p>
        </div>
