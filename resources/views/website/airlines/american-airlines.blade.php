    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          <li><a href="american-airlines.blade.php" class="airline-nav-item active">Overview</a></li>
          ...
          <li><a href="american-airlines-vacations.blade.php" class="airline-nav-item ">Vacations</a></li>
        </ul>
      </aside>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Overview</h2>
          <p>American Airlines is a major airline offering flights to domestic and international destinations. Welcome to our comprehensive guide where you can find all the information you need to make your journey smooth and enjoyable.</p>
        </div>
