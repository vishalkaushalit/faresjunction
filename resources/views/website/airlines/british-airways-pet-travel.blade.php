    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="british-airways-pet-travel.blade.php" class="airline-nav-item active">Pet Travel</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Pet Travel</h2>
          <p>Guidelines for bringing your pets in the cabin or traveling as cargo. Review breed restrictions and carrier requirements. with British Airways.</p>
        </div>
