    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="british-airways-destinations.blade.php" class="airline-nav-item active">Destinations</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          <h2>Destinations</h2>
          <p>Explore the vast network of cities and countries served across the globe. with British Airways.</p>
        </div>
