    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="delta-air-lines-loyalty.blade.php" class="airline-nav-item active">Loyalty Programs</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          ...
          <p>Discover our loyalty programs, how to earn miles, elite status tiers, and redemption options. with Delta Air Lines.</p>
        </div>
