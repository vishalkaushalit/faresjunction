    ...
    <div class="airline-layout">
      ...
      <aside class="airline-sidebar">
        <ul class="airline-nav-list">
          ...
          <li><a href="lufthansa-cancellation.blade.php" class="airline-nav-item active">Cancellation & Refund</a></li>
      ...
      <main class="airline-main-content">
        ...
        <div class="airline-tab-content active">
          ...
          <p>Understand the 24-hour flexible booking policy, basic economy restrictions, and how to request a refund. with Lufthansa.</p>
        </div>
