<div class="search-widget airline-search-widget" id="searchWidget">
    <div class="widget-tabs" role="tablist">
        <button class="tab-btn active" type="button" role="tab" aria-selected="true"
            aria-controls="flights-pane" id="tab-flights">
        ...
        <button class="tab-btn" type="button" role="tab" aria-selected="false" aria-controls="hotels-pane"
            id="tab-hotels">
            <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path
        ...
        <button class="tab-btn" type="button" role="tab" aria-selected="false"
            aria-controls="vacations-pane" id="tab-vacations">
            <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path
        ...
        <button class="tab-btn" type="button" role="tab" aria-selected="false" aria-controls="car-pane"
            id="tab-car">
            <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path
        ...
        <button class="tab-btn" type="button" role="tab" aria-selected="false" aria-controls="bus-pane"
            id="tab-bus">
            <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path
    ...
    <div class="widget-content">
        <div class="tab-pane active" id="flights-pane" role="tabpanel" aria-labelledby="tab-flights">
            <form class="search-form" id="flight-search-form" action="{{ route('website.flights') }}"
                method="GET">
        ...
        <div class="tab-pane" id="hotels-pane" role="tabpanel" aria-labelledby="tab-hotels">
            <form class="search-form" id="hotel-search-form" action="{{ route('website.hotels') }}"
                method="GET">
        ...
        <div class="tab-pane" id="vacations-pane" role="tabpanel" aria-labelledby="tab-vacations">
            <form class="search-form" id="vacation-search-form" action="{{ route('website.packages') }}"
                method="GET">
                <div class="form-grid">
                    <div class="input-wrapper">
                        <span class="input-icon">
        ...
        <div class="tab-pane" id="car-pane" role="tabpanel" aria-labelledby="tab-car">
            <form class="search-form" id="car-search-form" action="{{ route('website.cars') }}"
                method="GET">
                <div class="form-grid-5">
                    <div class="input-wrapper">
                        <span class="input-icon">
        ...
        <div class="tab-pane" id="bus-pane" role="tabpanel" aria-labelledby="tab-bus">
            <form class="search-form" id="bus-search-form" action="{{ route('website.flights') }}"
                method="GET">
                <div class="form-grid">
                    <div class="input-wrapper">
                        <span class="input-icon">
