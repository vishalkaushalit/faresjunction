    ...
    <div class="container hero-container">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                Call us at our 24/7 Number <a href="tel:+13238006001" class="hero-phone">+1 (323) 800-6001</a> to Get Best
                Flight Deals.
            </p>
        </div>
        ...
        <div class="search-widget" id="searchWidget">
            ...
            <div class="widget-tabs" role="tablist">
                <button class="tab-btn active" role="tab" aria-selected="true" aria-controls="flights-pane"
                    id="tab-flights">
                ...
                <button class="tab-btn" role="tab" aria-selected="false" aria-controls="hotels-pane"
                    id="tab-hotels">
                    <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                        <path
                ...
                <button class="tab-btn" role="tab" aria-selected="false" aria-controls="vacations-pane"
                    id="tab-vacations">
                    <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                        <path
                            d="M14.5 12c.83 0 1.5-.67 1.5-1.5S15.33 9 14.5 9s-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm5-6h-8v7H3V5H1v15h2v-3h18v3h2v-9c0-2.21-1.79-4-4-4z" />
                    </svg>
                    Vacations
                </button>
                <button class="tab-btn" role="tab" aria-selected="false" aria-controls="car-pane" id="tab-car">
                    <svg class="tab-icon" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                        <path
                            d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.27-3.82c.07-.21.27-.35.49-.35h10.48c.22 0 .42.14.49.35L19 11H5z" />
                    </svg>
                    Car
                </button>
            ...
            <div class="widget-content">
                    ...
                    <form class="search-form" id="flight-search-form" action="#" method="GET">
                        ...
                        <div class="form-modifiers">
                            ...
                            <div class="passenger-dropdown-container">
                                <button type="button" class="passenger-select-btn" id="passengerDropdownTrigger"
                                    aria-expanded="false" aria-haspopup="true">
                                    <span id="passenger-summary">1 Traveler Economy</span>
                                    <svg class="dropdown-chevron" viewBox="0 0 24 24" width="16" height="16"
                                        fill="currentColor">
                                ...
                                <div class="passenger-popup" id="passengerPopup" aria-hidden="true">
                                    <div class="popup-row">
                                        ...
                                        <div class="counter-control">
                                            <button type="button" class="btn-count minus" data-type="adults"
                                                aria-label="Decrease Adults">-</button>
                                            <span class="count-value" id="count-adults">1</span>
                                            <button type="button" class="btn-count plus" data-type="adults"
                                    ...
                                    <div class="popup-row">
                                        ...
                                        <div class="counter-control">
                                            <button type="button" class="btn-count minus" data-type="children"
                                                aria-label="Decrease Children">-</button>
                                            <span class="count-value" id="count-children">0</span>
                                            <button type="button" class="btn-count plus" data-type="children"
                                    ...
                                    <div class="popup-row">
                                        ...
                                        <div class="counter-control">
                                            <button type="button" class="btn-count minus" data-type="infants"
                                                aria-label="Decrease Infants">-</button>
                                            <span class="count-value" id="count-infants">0</span>
                                            <button type="button" class="btn-count plus" data-type="infants"
                                    ...
                                    <div class="popup-footer">
                                        <button type="button" class="btn btn-apply"
                                            id="applyPassengers">Apply</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="input-wrapper flying-from-wrapper">
                                ...
                                <input type="text" name="origin" id="origin-input" placeholder="Flying From"
                            ...
                            <!-- Swap Button -->
                            <button type="button" class="btn-swap" id="swapLocationsButton"
                            ...
                            <div class="input-wrapper flying-to-wrapper">
                                ...
                                <input type="text" name="destination" id="destination-input"
                                    placeholder="Flying To" autocomplete="off" required>
                                <!-- Suggestions -->
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="depart-date" id="depart-date-input"
                                    placeholder="Journey Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                            ...
                            <div class="input-wrapper date-wrapper" id="return-date-container">
                                ...
                                <input type="text" name="return-date" id="return-date-input"
                                    placeholder="Return Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                    ...
                    <form class="search-form" id="hotel-search-form" action="hotels.php" method="GET">
                        <div class="form-grid-5">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="destination" id="hotel-destination-input"
                                    placeholder="Where to? (Destination/Hotel Name)" autocomplete="off" required>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="checkin" id="hotel-checkin-input"
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="checkout" id="hotel-checkout-input"
                ...
                <div class="tab-pane" id="vacations-pane" role="tabpanel" aria-labelledby="tab-vacations">
                    <form class="search-form" id="vacation-search-form" action="packages" method="GET">
                        <div class="form-grid">
                            <!-- Flying From -->
                            <div class="input-wrapper">
                                <span class="input-icon">
                                ...
                                <input type="text" name="origin" id="vacation-origin-input"
                                    placeholder="Flying From" autocomplete="off" required>
                                <div class="autocomplete-list" id="vacation-origin-suggestions"></div>
                            </div>

                            <!-- Swap Button -->
                            <button type="button" class="btn-swap" id="vacationSwapButton"
                                aria-label="Swap departure and arrival locations">
                                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                                    <path d="M16 17.01V10h-2v7.01h-3L15 21l4-3.99h-3zM9 3L5 6.99h3V14h2V6.99h3L9 3z" />
                                </svg>
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="destination" id="vacation-destination-input"
                                    placeholder="Flying To" autocomplete="off" required>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="depart-date" id="vacation-depart-input"
                                    placeholder="Journey Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="return-date" id="vacation-return-input"
                                    placeholder="Return Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                    ...
                    <form class="search-form" id="car-search-form" action="cars.php" method="GET">
                        <div class="form-grid-5">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="pickup" id="car-pickup-input"
                                    placeholder="Pick-up Location (Airport / City)" autocomplete="off" required>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="pickup-date" id="car-pickup-date-input"
                                    placeholder="Pick-up Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="dropoff-date" id="car-dropoff-date-input"
                                    placeholder="Drop-off Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                    ...
                    <form class="search-form" id="bus-search-form" action="flights.php" method="GET">
                        <div class="form-grid">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="destination" id="bus-destination-input"
                                    placeholder="To (City / Station)" autocomplete="off" required>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="depart-date" id="bus-journey-date-input"
                                    placeholder="Journey Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
                            ...
                            <div class="input-wrapper date-wrapper">
                                ...
                                <input type="text" name="return-date" id="bus-return-date-input"
                                    placeholder="Return Date" onfocus="(this.type='date')"
                                    onblur="(this.value ? this.type='date' : this.type='text')" required>
                            </div>
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    <div class="feature-icon-wrapper">
                        <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                            <path
                                d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.287 4.114a6.286 6.286 0 010-12.57c2.519 0 4.56 1.8 5.143 4.229h4.286C22.56 4.3 17.96 0 12.24 0c-6.629 0-12 5.371-12 12s5.371 12 12 12c5.657 0 10.629-4.029 11.743-9.714v-4H12.24v.001z" />
                        </svg>
                    </div>
                    <div class="feature-info">
                        ...
                        <div class="google-stars">
                            ...
                            <svg viewBox="0 0 24 24">
                                <path
                                    d="M12 17.27l-4.18 2.2 1.1-4.7-3.64-3.15 4.8-.41L12 6.57l1.92 4.14 4.8.41-3.64 3.15 1.1 4.7z" />
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <div class="vacations-slider" id="vacationsSlider">
                ...
                <a href="<?php echo route('website.package-details', $key); ?>" class="vacation-card">
                    <div class="vacation-img-wrapper">
                        <img src="<?php echo htmlspecialchars($relPkg['heroImage']); ?>" alt="<?php echo htmlspecialchars($relPkg['title']); ?>" class="vacation-img"
                            loading="lazy">
                    </div>
...
<section class="destinations-section" id="destinations">
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-subtitle">Explore the world's most beloved destinations and find exclusive travel deals.
            </p>
        </div>
        <div class="destinations-grid">
            <!-- London -->
            <a href="flights.php" class="destination-card">
                <img src="https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&auto=format&fit=crop"
                    alt="London, United Kingdom" class="dest-img" loading="lazy">
                <div class="dest-overlay">
                    <span class="dest-country">United Kingdom</span>
                    <h3 class="dest-city">London</h3>
                    <span class="dest-link">Explore Deals <svg viewBox="0 0 24 24" width="14" height="14"
                            fill="currentColor">
            ...
            <!-- Paris -->
            <a href="flights.php" class="destination-card">
                <img src="https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?w=600&auto=format&fit=crop"
                    alt="Paris, France" class="dest-img" loading="lazy">
                <div class="dest-overlay">
            ...
            <!-- New York -->
            <a href="flights.php" class="destination-card">
                <img src="https://images.unsplash.com/photo-1518235506717-e1ed3306a89b?w=600&auto=format&fit=crop"
                    alt="New York, USA" class="dest-img" loading="lazy">
                <div class="dest-overlay">
            ...
            <!-- Tokyo -->
            <a href="flights.php" class="destination-card">
                <img src="https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600&auto=format&fit=crop"
                    alt="Tokyo, Japan" class="dest-img" loading="lazy">
                <div class="dest-overlay">
            ...
            <!-- Dubai -->
            <a href="flights.php" class="destination-card">
                <img src="https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&auto=format&fit=crop"
                    alt="Dubai, UAE" class="dest-img" loading="lazy">
                <div class="dest-overlay">
            ...
            <!-- Rome -->
            <a href="flights.php" class="destination-card">
                <img src="https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=600&auto=format&fit=crop"
                    alt="Rome, Italy" class="dest-img" loading="lazy">
                <div class="dest-overlay">
        ...
        <div class="blogs-grid">
            ...
            <a href="<?php echo route('website.blog-details', ['slug' => $bKey], false); ?>" class="blog-card">
                ...
                <div class="blog-content">
                    ...
                    <span class="blog-read-more">Read More <svg viewBox="0 0 24 24" width="14" height="14"
                            fill="currentColor">
                            <path d="M5 12h14M12 5l7 7-7 7" />
                        </svg></span>
                </div>
        ...
        <div class="testimonials-slider-wrapper">
            <div class="testimonials-slider" id="testimonialsSlider">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="review-body">I needed last-minute flights to London and Fares Junction got me an
                        unbeatable price within hours. Their agent was patient and professional throughout the whole
                        process. Highly recommend!</p>
                    <div class="reviewer-meta">
                        <div class="reviewer-avatar" style="background: linear-gradient(135deg, #ff7b25, #e56513);">MJ
                        </div>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="review-body">Traveling with family of 4 to Paris and the savings were incredible. The
                        booking process was smooth and transparent. Customer service was available anytime we had a
                        question.</p>
                    <div class="reviewer-meta">
                        <div class="reviewer-avatar" style="background: linear-gradient(135deg, #0d6efd, #0f294d);">SR
                        </div>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="review-body">My flight got cancelled and the support team at Fares Junction immediately
                        re-booked me on another flight with no extra charge. I couldn't believe how quickly they
                        resolved it.</p>
                    <div class="reviewer-meta">
                        <div class="reviewer-avatar" style="background: linear-gradient(135deg, #10b981, #059669);">DK
                        </div>
                        <div>
